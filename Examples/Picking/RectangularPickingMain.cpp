// Adapted for Rectangular Picking by François Cami <fcami@fedoraproject.org>
            ...
            osgGA::GUIActionAdapter& aa )
    {
        ...
        switch( ea.getEventType() )
        {
            ...
            case osgGA::GUIEventAdapter::MOVE:
            {
                ...
                //   and move events.
                _mX = ea.getXnormalized();
                _mY = ea.getYnormalized();
                return true;
            }
            case osgGA::GUIEventAdapter::RELEASE:
            {
                ...
                if (_mX == ea.getXnormalized() && _mY == ea.getYnormalized())
                {
                    if (pick( _mX, _mY, viewer ))
                        return true;
                }
                else
                {
...
protected:
    ...
    // Perform a rectangular pick operation.
    bool pick( const double xMin, const double yMin,
